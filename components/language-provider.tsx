...
const translations = {
  es: {
    ...
    "about.availability.title": "Disponibilidad y modalidad",
    "about.availability.contact": "Contactar por email",
    "experience.title": "Experiencia Profesional",
    "experience.current": "Actual",
    "experience.freelance": "Freelance",
    "experience.achievements": "Logros Principales",
    "experience.clients": "Sectores / clientes",
    "experience.showOlder": "Ver experiencia anterior",
    "experience.hideOlder": "Ocultar experiencia anterior",
    ...
    "assistant.privacy.detail":
      "Todo se procesa en tu navegador. Sin OpenAI, Anthropic ni Google Cloud.",
    ...
    "ailab.topicDistribution": "Distribución por tema",
    "ailab.gapRate": "Preguntas sin contexto",
    ...
    "interviews.title": "Entrevistas y apariciones",
    "interviews.subtitle": "Conversaciones sobre trayectoria, perfil T-shaped y docencia IT.",
    "interviews.play": "Reproducir entrevista",
    "interviews.cookieNotice":
      "Al reproducir el vídeo se cargan cookies de terceros de YouTube (youtube-nocookie). Consulta la política de cookies.",
    "legal.notice": "Aviso legal",
    "legal.privacy": "Privacidad",
    "legal.cookies": "Cookies",
    "legal.preferences": "Preferencias de privacidad",
    "consent.message":
      "Este sitio usa analítica anónima agregada (Vercel Analytics) para mejorar el portfolio. El chat IA se procesa 100% en tu navegador.",
    "consent.accept": "Entendido",
    "consent.reject": "Rechazar analítica",
  ...
  en: {
    ...
    "about.availability.title": "Availability and work model",
    "about.availability.contact": "Contact by email",
    "experience.title": "Professional Experience",
    "experience.current": "Current",
    "experience.freelance": "Freelance",
    "experience.achievements": "Key Achievements",
    "experience.clients": "Sectors / clients",
    "experience.showOlder": "Show earlier experience",
    "experience.hideOlder": "Hide earlier experience",
    ...
    "assistant.privacy.local": "local",
    "assistant.privacy.detail":
      "Everything runs in your browser. No OpenAI, Anthropic or Google Cloud.",
    ...
    "ailab.topicDistribution": "Topic distribution",
    "ailab.gapRate": "Questions without context",
    ...
    "interviews.title": "Interviews and appearances",
    "interviews.subtitle": "Conversations about career, T-shaped profile and IT teaching.",
    "interviews.play": "Play interview",
    "interviews.cookieNotice":
      "Playing the video loads third-party YouTube cookies (youtube-nocookie). See the cookie policy.",
    "legal.notice": "Legal notice",
    "legal.privacy": "Privacy",
    "legal.cookies": "Cookies",
    "legal.preferences": "Privacy preferences",
    "consent.message":
      "This site uses anonymous aggregated analytics (Vercel Analytics) to improve the portfolio. The AI chat runs 100% in your browser.",
